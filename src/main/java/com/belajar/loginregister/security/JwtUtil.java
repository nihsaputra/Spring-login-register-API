...
import com.belajar.loginregister.model.JwtClaim;
...
public class JwtUtil {
    @Value("${app.login-register.jwt-secret}")
    private String secretKey;

    @Value("${app.login-register.jwt-expirationInSecond}")
    private long expirationInSecond;

    @Value("${app.login-register.app-name}")
